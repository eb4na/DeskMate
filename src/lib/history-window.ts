...
// study/mood history; Memobun Plus unlocks the full archive (the "Advanced
 ...
 * shapes via string comparison: `SessionRecord.dateISO` ("2026-03-13") and the
 * full-ISO `MoodEntry.timestamp` ("2026-03-13T08:00:00.000Z") both compare
