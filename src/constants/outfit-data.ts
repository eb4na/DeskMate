...
export const CHARACTER_OUTFITS: Record<string, Outfit[]> = {
  ...
  'shop:companion_cocoa': [
    { id: 'outfit_cocoa_demon', name: 'Demon', emoji: '', price: 10000, characterId: 'shop:companion_cocoa', image: require('@/assets/images/cocoa/cocoa-demon.png') },
  ],
  'shop:companion_tira': [
  ...
  'shop:companion_bunny': [
    ...
    { id: 'outfit_bunny_bluebell', name: 'Bluebell', emoji: '', price: 7000, characterId: 'shop:companion_bunny', image: require('@/assets/images/bunny/bunny-bluebell.png') },
  ],
