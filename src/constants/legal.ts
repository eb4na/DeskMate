  ...
  privacy: [
    ...
    },
    {
      ...
      body: [
        ...
        'Advertising: the app offers optional rewarded video ads (for example, "Watch a video" in the coin shop), supplied by Google AdMob. If you choose to watch one, AdMob may receive your IP address and ad-interaction data such as whether the ad was viewed or completed. Ads are always non-personalized: Memobun does not track you across other companies\' apps or websites, does not ask for tracking permission, and does not use your device advertising identifier for personalized advertising. Memobun is fully usable without watching any ads.',
    ...
    },
    {
      ...
      body: [
        ...
        'Google AdMob — serves the optional rewarded video ads described above, and processes ad-interaction data. Ads are requested as non-personalized only.',
  ...
  privacy: [
    ...
    },
    {
      ...
      body: [
        ...
        '广告：应用提供可选的激励视频广告（例如金币商店中的“观看视频”），由 Google AdMob 提供。如果您选择观看，AdMob 可能会获得您的 IP 地址以及广告互动数据（例如广告是否被观看或看完）。广告始终为非个性化广告：Memobun 不会跨其他公司的应用或网站跟踪您，不会请求跟踪权限，也不会使用您的设备广告标识符投放个性化广告。即使不观看任何广告，您也可以完整使用 Memobun。',
    ...
    },
    {
      ...
      body: [
        ...
        'Google AdMob——提供上述可选的激励视频广告，并处理广告互动数据。广告仅以非个性化方式请求。',
  ...
  privacy: [
    ...
    },
    {
      ...
      body: [
        ...
        '廣告：應用程式提供可選的獎勵影片廣告（例如金幣商店中的「觀看影片」），由 Google AdMob 提供。如果您選擇觀看，AdMob 可能會取得您的 IP 位址以及廣告互動資料（例如廣告是否被觀看或看完）。廣告一律為非個人化廣告：Memobun 不會跨其他公司的應用程式或網站追蹤您，不會請求追蹤權限，也不會使用您的裝置廣告識別碼投放個人化廣告。即使不觀看任何廣告，您也可以完整使用 Memobun。',
    ...
    },
    {
      ...
      body: [
        ...
        'Google AdMob——提供上述可選的獎勵影片廣告，並處理廣告互動資料。廣告僅以非個人化方式請求。',
  ...
  privacy: [
    ...
    },
    {
      ...
      body: [
        ...
        '広告：本アプリでは、任意で視聴できるリワード動画広告（例：コインショップの「動画を見る」）を Google AdMob より配信しています。視聴を選択された場合、AdMob はお客様の IP アドレス、および広告が視聴されたか最後まで再生されたかといった広告インタラクションデータを受け取ることがあります。広告は常に非パーソナライズ広告です。Memobun は他社のアプリやウェブサイトにまたがる追跡を行わず、トラッキングの許可も求めず、パーソナライズ広告のために端末の広告識別子を利用することもありません。広告を一切視聴しなくても、Memobun のすべての機能をご利用いただけます。',
    ...
    },
    {
      ...
      body: [
        ...
        'Google AdMob——上記の任意のリワード動画広告を配信し、広告インタラクションデータを処理します。広告は非パーソナライズ広告としてのみリクエストされます。',
  ...
  privacy: [
    ...
    },
    {
      ...
      body: [
        ...
        '광고: 앱은 선택적으로 시청할 수 있는 보상형 동영상 광고(예: 코인 상점의 "동영상 보기")를 제공하며, 이는 Google AdMob이 제공합니다. 시청을 선택하시면 AdMob이 귀하의 IP 주소와 광고 시청 또는 완료 여부와 같은 광고 상호작용 데이터를 수신할 수 있습니다. 광고는 항상 비맞춤형입니다. Memobun은 다른 회사의 앱이나 웹사이트에서 귀하를 추적하지 않으며, 추적 권한을 요청하지 않고, 맞춤형 광고를 위해 기기 광고 식별자를 사용하지 않습니다. 광고를 전혀 시청하지 않아도 Memobun을 온전히 이용하실 수 있습니다.',
    ...
    },
    {
      ...
      body: [
        ...
        'Google AdMob — 위에서 설명한 선택적 보상형 동영상 광고를 제공하며, 광고 상호작용 데이터를 처리합니다. 광고는 비맞춤형으로만 요청됩니다.',
  ...
  privacy: [
    ...
    },
    {
      ...
      body: [
        ...
        'Publicidad: la aplicación ofrece anuncios de vídeo recompensados opcionales (por ejemplo, "Ver un vídeo" en la tienda de monedas), suministrados por Google AdMob. Si eliges ver uno, AdMob puede recibir tu dirección IP y datos de interacción con el anuncio, como si el anuncio se vio o se completó. Los anuncios son siempre no personalizados: Memobun no te rastrea en aplicaciones ni sitios web de otras empresas, no solicita permiso de seguimiento y no utiliza el identificador de publicidad de tu dispositivo para publicidad personalizada. Puedes usar Memobun por completo sin ver ningún anuncio.',
    ...
    },
    {
      ...
      body: [
        ...
        'Google AdMob: publica los anuncios de vídeo recompensados opcionales descritos arriba y procesa datos de interacción con los anuncios. Los anuncios se solicitan únicamente como no personalizados.',
  ...
  privacy: [
    ...
    },
    {
      ...
      body: [
        ...
        'Publicité : l’application propose des vidéos publicitaires récompensées facultatives (par exemple « Regarder une vidéo » dans la boutique de pièces), fournies par Google AdMob. Si vous choisissez d’en regarder une, AdMob peut recevoir votre adresse IP et des données d’interaction avec la publicité, par exemple si la publicité a été vue ou regardée jusqu’au bout. Les publicités sont toujours non personnalisées : Memobun ne vous suit pas dans les applications ou sites web d’autres entreprises, ne demande pas d’autorisation de suivi et n’utilise pas l’identifiant publicitaire de votre appareil à des fins de publicité personnalisée. Vous pouvez utiliser Memobun intégralement sans regarder la moindre publicité.',
    ...
    },
    {
      ...
      body: [
        ...
        'Google AdMob — diffuse les vidéos publicitaires récompensées facultatives décrites ci-dessus et traite les données d’interaction publicitaire. Les publicités sont demandées uniquement en version non personnalisée.',
